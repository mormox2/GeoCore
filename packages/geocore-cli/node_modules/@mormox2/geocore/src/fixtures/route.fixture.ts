...
} from "./rtimidental.fixture.js";
import {
  dawajinproFixture,
  dawajinProSiteUrl,
  dawajinProExpectedRoute,
} from "./dawajinpro.fixture.js";
 ...
 */
export const sampleRouteEntry: RouteEntry = {
 ...
 */
export const sampleRouteEntryWithAlternatesAndRedirects: RouteEntry = {
  ...sampleRouteEntry,
  ...
  ] satisfies RouteRedirect[],
};

/**
 * A clean two-route registry used by registry/conflict tests.
 */
export const sampleRouteRegistry: RouteRegistry = {
 ...
 */
export const rtimiDentalRouteRegistry: RouteRegistry = {
 ...
 */
export const dawajinProRouteRegistry: RouteRegistry = {
 ...
 */
export const rtimiDentalRouteInput: ResolveRoutesInput = {
  id: "route-registry-rtimidental",
  siteUrl: rtimiDentalSiteUrl,
 ...
 */
export const dawajinProRouteInput: ResolveRoutesInput = {
  id: "route-registry-dawajinpro",
  siteUrl: dawajinProSiteUrl,
 ...
 */
export const duplicatePathRegistry: RouteRegistry = {
  ...sampleRouteRegistry,
 ...
 */
export const selfRedirectRegistry: RouteRegistry = {
  ...sampleRouteRegistry,
 ...
 */
export const redirectLoopRegistry: RouteRegistry = {
  ...sampleRouteRegistry,
 ...
 * block publication.
 */
export const warningOnlyRegistry: RouteRegistry = {
  ...sampleRouteRegistry,
