 ...
 */
export type RouteType = "knowledge-object" | "collection" | "glossary-entry" | "documentation" | "media" | "api" | "llms" | "sitemap" | "static";
/**
 * Who may see a route. Only public routes are eligible for public outputs.
 */
export type RouteVisibility = "public" | "internal" | "private" | "hidden";
/**
 * Lifecycle status of a route, mirrored from the source object.
 */
export type RouteStatus = "draft" | "review" | "published" | "archived";
/**
