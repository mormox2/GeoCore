import { z } from "zod";
export declare const knowledgeRelationshipTypeSchema: z.ZodEnum<["related_to", "parent_of", "child_of", "part_of", "requires", "explains", "cites", "authored_by", "mentions", "uses_media", "translation_of", "alternative_to", "contrasts_with", "example_of", "classified_as", "reviewed_by", "supports", "verifies"]>;
export declare const knowledgeRelationshipStrengthSchema: z.ZodEnum<["weak", "medium", "strong", "canonical"]>;
export declare const knowledgeRelationshipConfidenceSchema: z.ZodEnum<["low", "medium", "high"]>;
