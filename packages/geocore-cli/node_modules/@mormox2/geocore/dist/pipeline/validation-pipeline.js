...
export function runValidationPipeline(input) {
    ...
    for (const stageId of order) {
        ...
        try {
            ...
            if (stageId === "dataset")
                code = codes.GC_PIPELINE_DATASET_INVALID;
            else if (stageId === "knowledge-objects")
                code = codes.GC_PIPELINE_KNOWLEDGE_OBJECTS_INVALID;
            else if (stageId === "relationships")
                code = codes.GC_PIPELINE_RELATIONSHIPS_INVALID;
            else if (stageId === "metadata")
                code = codes.GC_PIPELINE_METADATA_INVALID;
            else if (stageId === "routes")
                code = codes.GC_PIPELINE_ROUTES_INVALID;
            else if (stageId === "search")
                code = codes.GC_PIPELINE_SEARCH_INVALID;
            else if (stageId === "schema")
                code = codes.GC_PIPELINE_SCHEMA_INVALID;
            else if (stageId === "llms")
                code = codes.GC_PIPELINE_LLMS_INVALID;
            else if (stageId === "sitemap")
                code = codes.GC_PIPELINE_SITEMAP_INVALID;
            else if (stageId === "static-export")
                code = codes.GC_PIPELINE_STATIC_EXPORT_INVALID;
