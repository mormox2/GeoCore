...
import { createStaticExportAssetId, getMimeTypeForExportType, } from "./export-utils.js";
import { GC_EXPORT_NO_OBJECTS, GC_EXPORT_OBJECT_EXCLUDED, GC_EXPORT_ROUTE_MISSING, } from "../validation/validation-codes.js";
/**
...
export function createRendererInputForExport(input) {
    ...
    const resolvedMeta = metadata ?? deriveMinimalMetadata(object);
    return {
        objectId: object.id,
 ...
 * metadata was passed.
 */
function deriveMinimalMetadata(object) {
    return {
        id: object.id,
        slug: object.slug,
        title: object.title,
 ...
 */
export function generateStaticExport(input) {
 ...
 */
function normalizeRendererOutput(output) {
