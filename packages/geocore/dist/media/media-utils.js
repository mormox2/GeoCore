 ...
 */
export function isVideoMedia(asset) {
    return asset.type === "video";
}
/**
 * Returns true if the media asset is an audio file.
 */
export function isAudioMedia(asset) {
    return asset.type === "audio";
}
/**
 * Returns true if the media asset is a document.
 */
export function isDocumentMedia(asset) {
 ...
 */
export function getMediaExtension(source) {
