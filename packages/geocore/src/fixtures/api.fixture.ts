...
export const apiEntitiesFixture: KnowledgeEntity[] = [
  {
    id: "entity_scaling",
...
export const draftKnowledgeObject: KnowledgeObject = {
...
export const archivedKnowledgeObject: KnowledgeObject = {
...
export const apiKnowledgeObjectsFixture: KnowledgeObject[] = [
  rtimidentalFixture,
  {
...
export const apiDatasetFixture: KnowledgeDataset = {
  id: "dataset_test_api",
