...
export const whoOralHealthSource: KnowledgeSource = {
...
export const drMossaabProfessionalReview: KnowledgeSource = {
...
export const dawajinInternalReleaseNotes: KnowledgeSource = {
...
export const deprecatedSource: KnowledgeSource = {
...
export const scalingCitation: KnowledgeCitation = {
...
export const professionalReviewCitation: KnowledgeCitation = {
...
export const dawajinInternalCitation: KnowledgeCitation = {
...
export const removedCitation: KnowledgeCitation = {
...
export const allSourcesFixture: KnowledgeSource[] = [
  whoOralHealthSource,
  drMossaabProfessionalReview,
  dawajinInternalReleaseNotes,
];

export const allCitationsFixture: KnowledgeCitation[] = [
  scalingCitation,
