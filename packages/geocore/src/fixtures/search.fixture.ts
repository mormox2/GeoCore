...
import { CreateSearchDocumentInput } from "../search/search-document.js";
import { ResolvedMetadata } from "../types/metadata.js";

export const rtimiDentalResolvedMetadata: ResolvedMetadata = {
...
export const rtimiDentalSearchDocumentInput: CreateSearchDocumentInput = {
...
export const dawajinProResolvedMetadata: ResolvedMetadata = {
...
export const dawajinProSearchDocumentInput: CreateSearchDocumentInput = {
  object: dawajinproFixture,
  metadata: dawajinProResolvedMetadata,
  relationships: dawajinRelationships,
  entities: entitiesFixture.filter((e) =>
    ["entity_customer_balance", "entity_invoice", "entity_payment"].includes(e.id)
  ),
