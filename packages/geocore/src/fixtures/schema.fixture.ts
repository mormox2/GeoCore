...
import { GenerateJsonLdInput } from "../schema/json-ld-generator.js";

export const rtimiDentalSchemaInput: GenerateJsonLdInput = {
...
export const dawajinProSchemaInput: GenerateJsonLdInput = {
